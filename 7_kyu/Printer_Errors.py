...
def printer_error(s):
    # def bad chars and variable for tracking
    invalid = 'nopqrstuvwxyz'
    detected = []

    # parse input and detect errors
    [ detected.append(i) for i in s if i in invalid ]

    # format output
    return f'{len(detected)}/{len(s)}' 